...
ActiveRecord::Schema.define(version: 9) do
  ...
  create_table 'enemies', force: :cascade do |t|
    ...
    t.index %w[user_1_id user_2_id], name: 'index_enemies_on_user_1_id_and_user_2_id', unique: true
  end
  ...
  create_table 'friends', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_1_id user_2_id], name: 'index_friends_on_user_1_id_and_user_2_id', unique: true
  end
  ...
  create_table 'invites', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[user_1_id user_2_id], name: 'index_invites_on_user_1_id_and_user_2_id', unique: true
  end
  ...
  create_table 'layouts', force: :cascade do |t|
    ...
    t.index %w[user_id game_id x y], name: 'index_layouts_on_user_id_and_game_id_and_x_and_y', unique: true
  end
  ...
  create_table 'moves', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[game_id user_id x y], name: 'index_moves_on_game_id_and_user_id_and_x_and_y', unique: true
  end
